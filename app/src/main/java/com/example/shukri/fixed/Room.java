...
//                            }
        ...
        if(t1.length()>0 || t2.length()>0 || t3.length()>0) {
            msg += fiksuar + " fiksuar," + qelluar + " qelluar";
            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, nr_list);
    ...
    public void showAnimation(){
        new ParticleSystem(this, 80, R.drawable.confeti2, 7000)
